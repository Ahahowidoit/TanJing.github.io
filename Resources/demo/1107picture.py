    ...
    for file_name in os.listdir(folder_path):
        ...
        for row in ws.iter_rows():
            ...
            for cell in row:
                ...
                headers = {
                    ...
                    'Authorization': 'YTX_STORE;eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9.eyJyb2xlIjoiMTEwIiwidW5pcXVlX25hbWUiOiLosK3pnZkiLCJ1c2VySWQiOiIxMDA1MjMiLCJpc3MiOiJyZXN0YXBpdXNlciIsImF1ZCI6IndZRGd2RkV3dUVIWkNySmxsdTFxSWlpRlVWcmcyeXA5IiwiZXhwIjoxNjk5NTE3NzM0LCJuYmYiOjE2OTkzNDQ5MzR9.uOoGegwYGgVfELQGG9MM1s6bdVSJ7-b_k3uXh5bEO6M',
        ...
        for barcode, img_path in image_paths.items():
            ...
            for row in ws.iter_rows():
                ...
                img_cell_position = ''
                for cell in row:
                    if cell.column_letter == 'D' and cell.value != '总计' and cell.value != '主条形码':
                        cell_barcode = cell.value
                        barcode_cell_position =cell
                    if cell.column_letter == 'D' and cell.value == '总计':
                        continue
...
get_images_from_folder('E:/other/picture/1107picture', 'E:/other/save_picture/picture1107')
